            ...
            <q-card-section class="text-center q-py-lg">
                <div class="q-px-md">
                    ...
                    <!-- <q-slider
                        ...
                        :min="1"
                        :max="Object.keys(timeRangeInfo).length"
...
export default {
    ...
    methods: {
        serviceActivateDeactivateHandle() {
            ...
            this.$store
                .dispatch("domain_uptime/updateDomainUptimeCheckService", {
                    vm: this,
                ...
                .then(res => {
                    ...
                    this.$q.notify({
                        color: "positive",
                        message:
                            "Uptime monitor checker service has been updated Successful",
                        position: "top"
                    });
            ...
            handler() {
                if (this.projectInfo.id) {
                    if (
                        ...
                        let checkTypes = this.projectInfo.domain_use_for
                            .domain_uptime_check_service.check_types;
                        // let timeRange = this.projectInfo.domain_use_for
                        //     .domain_uptime_check_service.time_range;
                        let status = this.projectInfo.domain_use_for
                            .domain_uptime_check_service.status;

                        this.uptimeInfo.checkTypes =
                            checkTypes && checkTypes.length
                                ? checkTypes[0]
                                : "";
                        // this.uptimeInfo.timeRange =
                        //     parseInt(
                        //         this.$_.invert(this.timeRangeInfo)[timeRange]
                        //     ) || 1;
