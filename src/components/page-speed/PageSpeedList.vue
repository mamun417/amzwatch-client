                                ...
                                <q-item-section>
                                    <div class="row items-center">
                                        ...
                                        >
                                            ...
                                            >
                                            {{calculateScoreType(page.meta[device].audits[key].score * 100).type}}
                                        </span>
                                            <span v-else class="q-ml-xs text-warning">Pending</span>
                                        </div>
                                    </div>
                    ...
                    <q-card-section>
                        ...
                        <q-item class="shadow-1 q-py-xl" clickable>
                            <div
                                ...
                                :key="index"
                            >
                                <div class="q-mb-md text-primary text-subtitle2">{{$_.upperFirst($_.lowerCase(cr))}}</div>
    ...
    export default {
        ...
        methods: {
            ...
            pageSpeedListPaginationHandle(page) {
                this.$store.dispatch('pages_speed/updatePageSpeedListCurrentPage', page)
                    .then(() => {
                        this.getPagesSpeedInfo();
                    })
            }
